...
class LoginActivity : MvpActivity<LoginView,LoginPresenter>(),LoginView ,View.OnClickListener{
    ...
    override fun loginUser(success: LoginResponse?) {
        /*
        The email and password for the login is dipesh32@gmail.com and 123456
        Since my URL is http://demo3147732.mockable.io/login?email=dipesh32@gmail.com&password=123456
